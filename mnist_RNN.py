...
def mnist_cat():
    ...
    model = Sequential()
    model.add(SimpleRNN(output_dim=n_hidden, input_shape=(length, dim_in), return_sequences=True))
    ...
    model.save('keras_mnist-RNN-ElmanNet_1-9_model.h5')# モデル構造と重みパラメータを含む
...
def mnist_bi():
    ...
    model.save('keras_mnist-RNN-ElmanNet_4or9_model.h5')# モデル構造と重みパラメータを含む
