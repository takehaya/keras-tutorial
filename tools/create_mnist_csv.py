...
def main():
    ...
    train_csv = data_iterator_to_csv(path, 'mnist_training.csv', './training', train_di)
    ...
    test_csv = data_iterator_to_csv(path, 'mnist_test.csv', './validation', validation_di)

    # Create one-hot training set
    logger.log(99, 'Creating "mnist_training_onehot.csv"... ')
    create_onehot_dataset(train_csv, os.path.join(path, "mnist_training_onehot.csv"), 10)

    # Create one-hot test set
    logger.log(99, 'Creating "mnist_test_onehot.csv"... ')
    create_onehot_dataset(test_csv, os.path.join(path, "mnist_test_onehot.csv"), 10)
